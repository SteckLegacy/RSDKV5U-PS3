...
* This version is a port for PlayStation 3.
* This version is complete!

* ~~Make Data.rsdk files work.~~ (Done)
* ~~Fix sound. (Done)
* ~~Fix performance.~~ (Done)
* ~~Make the game not crash on exit.~~ (Done)
* ~~Improve controller input.~~ (Done)
* ~~Four-player controller support.~~ (Done)
* ~~Enable mods.~~ (Done)
* ~~Adapt to any resolution.~~ (Done)
---------------------------------------------------------------------------------------------------------------------------------------------------------
# Acerca del proyecto

* Esta versión es una adaptación para PlayStation 3.
* ¡Esta versión está completa!

* ~~Hacer que los archivos Data.rsdk funcionen.~~ (Listo)
* ~~Corregir el sonido. (Listo)
* ~~Corregir el rendimiento.~~ (Listo)
* ~~Hacer que el juego no se cierre al salir.~~ (Listo)
* ~~Mejorar la entrada del mando.~~ (Listo)
* ~~Compatibilidad con mandos para cuatro jugadores.~~ (Listo)
* ~~Habilitar mods.~~ (Listo)
* ~~Adaptarse a cualquier resolución.~~ (Listo)
---------------------------------------------------------------------------------------------------------------------------------------------------------
